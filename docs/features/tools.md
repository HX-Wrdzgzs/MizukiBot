...
<div style="background: var(--vp-c-bg-soft); border: 2px solid #b37feb; padding: 20px; border-radius: 15px; margin-bottom: 25px;">
<h3 style="margin-top: 0; color: #722ed1;">表情包系统 (Meme System)</h3>
<p style="font-size: 13px; opacity: 0.8;">集成审核、溯源、压缩包批量上传的表情管理系统。</p>
<div style="display: flex; flex-wrap: wrap; gap: 20px; margin-top: 15px;">
<div style="flex: 1; min-width: 240px;">
<h4 style="color: #722ed1; margin-bottom: 10px; border-bottom: 1px dashed #d3adf7;">基础指令</h4>
...
<div style="flex: 1; min-width: 240px;">
<h4 style="color: #722ed1; margin-bottom: 10px; border-bottom: 1px dashed #d3adf7;">上传系统</h4>
<ul style="font-size: 13px; line-height: 1.8; opacity: 0.9; padding-left: 20px; margin: 0;">
<li><code>[文件夹] 上传 [图片]</code> (Bot本地库)</li>
<li><code>[文件夹] pic上传 [图]</code> (Mzk API库)</li>
<li><code>[文件夹] kuma上传 [图]</code> (Kuma API库)</li>
</ul>
</div>
</div>
<details style="margin-top: 15px;">
<summary style="cursor: pointer; color: #b37feb; font-size: 13px; font-weight: bold;">管理员指令 (点击展开)</summary>
<div style="background: var(--vp-c-bg-alt); padding: 15px; border-radius: 8px; margin-top: 10px; font-size: 13px; border: 1px dashed #d3adf7;">
<p><code>最近上传</code> - 查看入库记录</p>
<p><code>删除 [图片名]</code> - 删图+删库</p>
<p><code>溯源 [图片名]</code> - 查上传者</p>
<p><code>锁定/解锁 [文件夹]</code></p>
<p><code>屏蔽群/解除屏蔽 [群号]</code></p>
</div>
</details>
...
<span style="font-size: 13px; opacity: 0.8;">指令: <code>pjsk [ID] [文本]</code></span>
<a href="/features/meme" style="margin-left: 10px; font-size: 12px; color: #722ed1; text-decoration: underline;">查看制作教程 -></a>
</div>
</div>

<div style="background: var(--vp-c-bg-soft); border-left: 5px solid #1890ff; padding: 20px; border-radius: 10px; margin-bottom: 25px;">
<h3 style="margin-top: 0; color: #1890ff;">看看群U发言</h3>
<p style="font-size: 13px; opacity: 0.9;">
<code>今日发言</code> / <code>本月发言</code> / <code>今年发言</code><br>
(管理) <code>全群统计</code> / <code>今日DAU</code>
</p>
</div>

<div style="display: flex; flex-wrap: wrap; gap: 20px; margin-bottom: 25px;">
<div style="flex: 1; min-width: 300px; background: var(--vp-c-bg-soft); border-left: 5px solid #52c41a; padding: 20px; border-radius: 10px;">
<h3 style="margin-top: 0; color: #52c41a;">Minecraft 服务器</h3>
<p style="font-size: 13px; font-weight: bold;">版本：<span style="background:rgba(82, 196, 26, 0.1); color:#52c41a; padding: 2px 6px; border-radius: 4px;">Fabric 1.21.4</span></p>
<p style="font-size: 13px; opacity: 0.8;">IP地址与整合包请在群内获取。</p>
...
<div style="background: var(--vp-c-bg-soft); border-left: 5px solid #fa8c16; padding: 20px; border-radius: 10px;">
