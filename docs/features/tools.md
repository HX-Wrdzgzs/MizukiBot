...
<div style="background: #f9f0ff; border: 2px solid #b37feb; padding: 20px; border-radius: 15px; margin-bottom: 25px; box-shadow: 0 4px 15px rgba(179, 127, 235, 0.1);">
  <h3 style="margin-top: 0; color: #722ed1; display:flex; align-items:center; justify-content:space-between;">
    <span>🖼️ Meme 随机</span>
    <span style="font-size:12px; background:#722ed1; color:#fff; padding:2px 8px; border-radius:10px;">Final V40 6</span>
  </h3>
  <p style="font-size: 13px; color: #666;">全功能版：双API通道(Mzk/Kuma)、最近上传、风控修复。</p>
  ...
  <div style="display: flex; flex-wrap: wrap; gap: 20px; margin-top: 15px;">
    ...
    <div style="flex: 1; min-width: 240px;">
      ...
      <ul style="font-size: 13px; line-height: 1.8; color: #555; padding-left: 20px; margin: 0;">
        ...
        <li><code>发送 [文件夹名]</code></li>
        <li><code>查看 [图片名]</code></li>
        <li><code>看所有 [文件夹名]</code></li>
      </ul>
    </div>
    ...
    <div style="flex: 1; min-width: 240px;">
      ...
      <ul style="font-size: 13px; line-height: 1.8; color: #555; padding-left: 20px; margin: 0;">
        <li><code>[文件夹] 上传 [图/ZIP]</code> <span style="color:#999; font-size:12px;">(Bot本地库)</span></li>
        <li><code>[文件夹] pic上传 [图]</code> <span style="color:#eb2f96; font-size:12px;">(Mzk API库)</span></li>
        <li><code>[文件夹] kuma上传 [图]</code> <span style="color:#fa8c16; font-size:12px;">(Kuma API库)</span></li>
      </ul>
    </div>
